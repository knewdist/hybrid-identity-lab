...
## Privileged Role Activation Notification

When the `cloud-admin` user activated the **User Administrator** role,
Microsoft Entra ID generated a security notification email confirming
the privilege elevation.

This demonstrates how organizations receive alerts whenever a
privileged role is activated through Privileged Identity Management.
...
![PIM Activation Email](../screenshots/08.5/pim-activation-email.png)
